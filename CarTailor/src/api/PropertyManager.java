...
public interface PropertyManager {
	...
	/**
	* Returns an immutable set of the property names supported by the
	property manager.
	*
	* @return
	*/
	...
	/**
	* Returns the immutable set of discrete string values for a given
	property.
	* For properties that have a non explicit set of possible values (eg
	double converted to strings),
